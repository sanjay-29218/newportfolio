...
export default function Skills({}: Props) {
  return (
    ...
    >
      <h3
        className=" top-24 uppercase tracking-[20px]
         text-gray-500 text-2xl"
      >
        Skills
      </h3>
      <h3
        className=" top-36 uppercase tracking-[5px]
         text-gray-900 text-sm md:text-md md:tracking-[10px]"
      >
        Hover over a slill for current proficincy
      </h3>
      ...
      <div className="grid grid-cols-3 gap-4 pt-5">
        ...
        <Skill directionLeft={false} src={"/mysql.png"} percentage={"80%"} />
        <Skill directionLeft={false} src={"/gcs.png"} percentage={"80%"} />
        <Skill directionLeft={false} src={"/node.png"} percentage={"80%"} />
        <Skill directionLeft={false} src={"/mongo.png"} percentage={"80%"} />
        <Skill directionLeft={false} src={"nest.png"} percentage={"80%"} />
      </div>
    </motion.div>
  );
}
